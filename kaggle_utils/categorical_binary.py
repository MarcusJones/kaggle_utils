...
# This is just a small modified version, with convert_input() now able to 
# handle isinstance(X, pd.core.arrays.categorical.Categorical)
...
def convert_input(X):
    #print(type(X))
    if isinstance(X, pd.core.arrays.categorical.Categorical):
